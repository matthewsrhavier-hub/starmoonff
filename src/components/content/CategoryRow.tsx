      ...
      <div className="flex items-center justify-between mb-3 px-6 md:px-10 lg:px-14">
        {href ? (
          <Link href={href} className="group flex items-center gap-2">
            <h2 className="text-base md:text-lg font-semibold text-white group-hover:text-white/80 transition-colors">
              {title}
            </h2>
            <ChevronRight
              size={16}
              strokeWidth={2}
              className="text-white/40 opacity-0 -translate-x-1 group-hover:opacity-100 group-hover:translate-x-0 transition-all"
            />
          </Link>
        ) : (
