  ...
  return (
    <div className="mb-8">
      <div className="flex items-center gap-2 mb-4">
        <Heart size={20} className="text-[var(--accent-teal)]" fill="currentColor" />
          ...
          {favorites.map((fav) => (
            ...
            >
              <button
                ...
                className="w-full bg-[var(--bg-secondary)] rounded-xl overflow-hidden hover:bg-[var(--bg-elevated)] transition-all hover:scale-105 border border-white/5"
              >
                {/* Badge LIVE */}
                ...
                {/* Logo */}
                <div className="aspect-video flex items-center justify-center p-4 bg-gradient-to-br from-[var(--bg-elevated)] to-[var(--bg-secondary)] relative">
                  {fav.channel_logo ? (
                    <img
                  ...
                  <div className="absolute inset-0 bg-black/40 opacity-0 group-hover/card:opacity-100 transition-opacity flex items-center justify-center">
                    <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center">
                      <Play size={24} className="text-[#040714] ml-1" fill="currentColor" />
                    </div>
                  </div>
                </div>
              ...
              <button
                ...
                className="absolute top-2 right-2 z-10 p-1.5 rounded-full bg-black/50 hover:bg-white/20 transition-colors border border-white/10"
                title="Remover dos favoritos"
              >
                <Heart size={14} className="text-[var(--accent-teal)] fill-[var(--accent-teal)]" />
              </button>
            </div>
          ))}
        </div>
