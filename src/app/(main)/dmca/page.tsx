  ...
  return (
    <CatalogPageBody>
      <div className="max-w-3xl mx-auto">
        ...
        <h1 className="text-headline text-white mb-2">DMCA — Direitos Autorais</h1>
        ...
        <div className="space-y-8 text-[var(--text-secondary)]">
          {/* Important Notice */}
          <div className="bg-[var(--accent-teal)]/10 border border-[var(--accent-teal)]/20 rounded-2xl p-6 flex gap-4">
            <AlertTriangle className="text-[var(--accent-teal)] flex-shrink-0 mt-1" size={24} />
            <div>
              <h3 className="text-lg font-semibold text-white mb-2">Aviso Importante</h3>
              <p className="text-[var(--text-secondary)]">
                O Starmoon respeita os direitos de propriedade intelectual de terceiros.
          ...
          <section className="space-y-4">
            ...
            <p>
              O Starmoon opera como um serviço de agregação de links. Não armazenamos,
          ...
          <section className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3">
                <CheckCircle className="text-[var(--accent-teal)] flex-shrink-0 mt-1" size={20} />
